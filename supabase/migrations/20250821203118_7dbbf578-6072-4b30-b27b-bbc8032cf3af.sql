-- Drop foreign key constraints that reference auth.users for development
ALTER TABLE employees DROP CONSTRAINT IF EXISTS employees_user_id_fkey;

-- Now create sample employees and data
...
-- Create comprehensive sample timesheets with various statuses
