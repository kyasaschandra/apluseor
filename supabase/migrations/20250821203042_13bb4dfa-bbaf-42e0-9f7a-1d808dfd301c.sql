-- Create sample employees with correct enum values
...
-- Create comprehensive sample timesheets
...
-- Add comprehensive timesheet entries
INSERT INTO timesheet_entries (id, timesheet_id, work_date, hours, overtime_hours, project, task, notes) VALUES
  ...
  -- Bob Wilson's timesheets (contractor)
